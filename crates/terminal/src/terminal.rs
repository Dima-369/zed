...
impl Terminal {
    ...
    pub fn vi_motion(&mut self, keystroke: &Keystroke) {
        ...
        let motion: Option<ViMotion> = match key.as_ref() {
            ...
            "t" | "down" => Some(ViMotion::Down),
            "c" | "up" => Some(ViMotion::Up),
            "n" | "right" => Some(ViMotion::Right),
            "r" => Some(ViMotion::WordRight),
            "g" if !keystroke.modifiers.control => Some(ViMotion::WordLeft),
